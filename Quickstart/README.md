* goal
  * build a “Hello World!” endpoint / reply -- by -- your name 

# requirements
* IDE
  * _Examples:_ 
    * [IntelliJ IDEA](https://www.jetbrains.com/idea/)
    * [Visual Studio Code + Spring Boot Extension pack](https://code.visualstudio.com/docs/languages/java)
    * [Eclipse](https://www.eclipse.org/downloads/packages/)
* JDK
  * recommendations
    * [BellSoft Liberica JDK v17 or 21](https://bell-sw.com/pages/downloads/)
* TODO:
    ...
    <div class='content' role='Main'>
        <div class='container'>
            <section id='steps' class='mb-5 mw-850'>
                ...
                <img id='init' class='mx-auto block mb-4 img-light' data-th-src="@{/images/quick-img-1.png}" alt='The Spring Initializr (start.spring.io) being asked to generate a simple Spring Boot ‘Web’ project. Hitting the ‘generate’ button will create an archive of a project which you can unpack and use to get started.' title='The Spring Initializr (start.spring.io) being asked to generate a simple Spring Boot ‘Web’ project. Hitting the ‘generate’ button will create an archive of a project which you can unpack and use to get started.'>
                <img id='init-2' class='mx-auto block mb-4 img-dark' data-th-src="@{/images/quick-img-1-dark.png}" alt='The Spring Initializr (start.spring.io) being asked to generate a simple Spring Boot ‘Web’ project. Hitting the ‘generate’ button will create an archive of a project which you can unpack and use to get started.' title='The Spring Initializr (start.spring.io) being asked to generate a simple Spring Boot ‘Web’ project. Hitting the ‘generate’ button will create an archive of a project which you can unpack and use to get started.'>
              ...
              public class DemoApplication {<br/>
                ...
                <p><b>MacOS/Linux:</b><br><pre><code class='inline-block'>./gradlew spring-boot:run</code></pre></p>
                <p><b>Windows:</b><br><pre><code class='inline-block'>gradlew.bat spring-boot:run</code></pre></p>
                <p>You should see some output that looks very similar to this:</p>
                <img alt='The terminal outputting various log statements as our Spring Boot application starts up.' title='The terminal outputting various log statements as our Spring Boot application starts up.' data-th-src="@{/images/quick-img2.png}">
                ...
                <img class='shadow mb-3' alt='The browser screen displaying the default ‘hello world’ output from our application.' title='The browser screen displaying the default ‘hello world’ output from our application.' data-th-src="@{/images/quick-img3.png}">
                <img id='pop-quiz' class='inline-block' data-th-src="@{/images/pop-quiz.svg}">
                ...
                <div class='flex jc-between'>
                    <a href='/guides/gs/rest-service' class='card block border shadow-hover bg-white border-box third rad-5'>
                        <div class='flex title'>
                            <img data-th-src="@{/images/icon-guides-start.svg}" alt=''>
                    ...
                    <a data-th-href='@{/guides/gs/consuming-rest}' class='card block border shadow-hover bg-white border-box third rad-5'>
                        <div class='flex title'>
                            <img data-th-src="@{/images/icon-guides-start.svg}" alt=''>
                    ...
                    <a data-th-href='@{/guides/gs/accessing-data-jpa}' class='card block border shadow-hover bg-white border-box third rad-5'>
                        <div class='flex title'>
                            <img data-th-src="@{/images/icon-guides-start.svg}" alt=''>

...
<div>
    <div id='hero' role='banner'>
        <div class='container'>
            ...
            <img class="theme-light illustration-why-spring" id='illustration' data-th-src="@{/images/why-spring-02.svg}" alt=''>
            <img class="theme-dark illustration-why-spring" data-th-src="@{/images/why-spring-02-dark.svg}" alt=''>

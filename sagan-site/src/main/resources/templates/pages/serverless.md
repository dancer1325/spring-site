...
<div>
    <div id='hero' class='topics-banner mb-5'>
        <div id="midshape" data-th-insert="~{svg/_shapes :: header-serverless}"></div>
    </div>
    <div class='content' role='Main'>
        <section class='container mb-5'>
            ...
            <div class='flex jc-between topic-hero mb-2'>
                ...
                <img class='as-fs topic-icon img-light' data-th-src="@{/images/serverless.svg}" alt=''>
                <img class='as-fs topic-icon img-dark' data-th-src="@{/images/serverless-dark.svg}" alt=''>
            </div>
                ...
                <div class='right'>
                    <div class='diagram-container'>
                        <div class="center mb-3">
                            <img class='center mb-3 img-light' data-th-src="@{/images/diagram-serverless-standalone.svg}"
                                 alt='Function as a Service (FaaS) and Legacy diagram'>
                            <img class='center mb-3 img-dark' data-th-src="@{/images/diagram-serverless-standalone-dark.svg}"
                                 alt='Function as a Service (FaaS) and Legacy diagram'>
                        </div>
                        <div class='flex jc-between'>
                            <div class='half'>
                ...
                <div class='flex jc-between'>
                    <div class='item third'>
                        <a class='thumbnail mb-1 block' href='https://www.youtube.com/watch?v=8tOj4A7jgWg'>
                            <img data-th-src="@{/images/serverless-res1.png}" alt='Play "Spring, Functions, Serverless, and You" on YouTube'>
                    ...
                    <div class='item third'>
                        <a class='thumbnail mb-1 block' href='/blog/2018/05/16/spring-tips-project-riff-and-spring-cloud-function'>
                            <img data-th-src="@{/images/serverless-res2.png}" alt='Spring Tips: Project Riff and Spring Cloud Function'>
                        </a>
                    ...
                    <div class='item third'>
                        <a class='thumbnail mb-1 block' href='https://www.youtube.com/watch?v=mPOl3024R4s'>
                            <img data-th-src="@{/images/serverless-res3.png}" alt='Play "Serverless Spring" on YouTube'>
                            <div class='play'><div class='relative'><div class='triangle'></div></div></div>
                        </a>

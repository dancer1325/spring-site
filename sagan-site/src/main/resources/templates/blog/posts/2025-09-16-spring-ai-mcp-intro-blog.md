...
source: https://spring.io/blog/2025/09/16/spring-ai-mcp-intro-blog
scraped: 2026-02-23T07:28:22.893Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  September 16, 2025 | 0 Comments
---

# Connect Your AI to Everything: Spring AI's MCP Boot Starters

_Engineering | Christian Tzolov |  September 16, 2025 | 0 Comments_
...
#### [](#spring-boot-server-application)Spring Boot Server application
...
```bash
Copyspring.ai.mcp.server.protocol=STREAMABLE
```
...
```bash
Copynpx @modelcontextprotocol/inspector
```
...
### [](#advanced-server-features)Advanced Server Features
...
![MCP Capabilities](https://raw.githubusercontent.com/spring-io/spring-io-static/refs/heads/main/blog/tzolov/20250911/MCP-SAMPLING-SEQ.svg )
...
#### [](#spring-boot-client-application)Spring Boot Client Application
...
#### [](#client-mcp-handlers)Client MCP Handlers
...
##### [](#understanding-the-handler-components)Understanding the Handler Components:
...
-   **Annotation-Based Routing**: The `clients = "my-weather-server"` attribute ensures handlers only process notifications from the specific MCP server connection defined in your configuration: `spring.ai.mcp.client.streamable-http.connections.[my-weather-server].url`.
    ...
    ```java
    Copy@McpProgress(clients = {"weather-server", "database-server"})  // Handle progress from multiple servers

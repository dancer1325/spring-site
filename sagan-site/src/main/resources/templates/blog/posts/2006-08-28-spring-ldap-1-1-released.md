---
title: Spring LDAP 1.1 Released
source: https://spring.io/blog/2006/08/28/spring-ldap-1-1-released
scraped: 2026-02-24T09:35:17.461Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Mattias Arthursson |  August 28, 2006 | 0 Comments
---

# Spring LDAP 1.1 Released

_Releases | Mattias Arthursson |  August 28, 2006 | 0 Comments_

Dear Spring Community,

We are pleased to announce that Spring LDAP version 1.1 has been released. This is the first release of the library as a Spring Framework sub project. [Download](http://sourceforge.net/project/showfiles.php?group_id=73357&package_id=202038) | [Documentation](http://static.springframework.org/spring-ldap/docs/1.1/reference/) | [API](http://static.springframework.org/spring-ldap/docs/1.1/api/)

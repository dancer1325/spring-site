---
title: Spring Boot 3.0.1 available now
source: https://spring.io/blog/2022/12/22/spring-boot-3-0-1-available-now
scraped: 2026-02-23T10:20:23.730Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Phil Webb |  December 22, 2022 | 0 Comments
---

# Spring Boot 3.0.1 available now

_Releases | Phil Webb |  December 22, 2022 | 0 Comments_
...
This release includes [54 bug fixes, documentation improvements, and dependency upgrades](https://github.com/spring-projects/spring-boot/releases/tag/v3.0.1). Thanks to all those who have contributed with issue reports and pull requests.

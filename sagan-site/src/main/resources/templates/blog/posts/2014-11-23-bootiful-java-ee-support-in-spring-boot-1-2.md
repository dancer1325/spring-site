...
source: https://spring.io/blog/2014/11/23/bootiful-java-ee-support-in-spring-boot-1-2
scraped: 2026-02-23T22:06:12.545Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Josh Long |  November 23, 2014 | 6 Comments
---

# "Bootiful" Java EE Support in Spring Boot 1.2

_Engineering | Josh Long |  November 23, 2014 | 6 Comments_

In this blog, I want to look at - and demonstrate - some of the *many* new features in [Spring Boot 1.2](http://projects.spring.io/spring-boot/) that make the lives of those coming from, or otherwise building on, Java EE easier.
...
## [](#jax-rs-with-jersey)JAX-RS with Jersey
...
## [](#global-transactions-with-jta)Global Transactions with JTA
...
## [](#the-undertow-embedded-web-server)The Undertow embedded web-server
...
This example relies on a Spring Boot [auto-configured and embedded](http://docs.spring.io/spring-boot/docs/1.2.0.RC2/reference/htmlsingle/#howto-configure-a-datasource), in-memory [H2](http://www.h2database.com/html/main.html) `javax.sql.DataSource` and - a Spring Boot [auto-configured and embedded](http://docs.spring.io/spring-boot/docs/1.2.0.RC2/reference/htmlsingle/#boot-features-hornetq), in-memory [HornetQ](http://hornetq.jboss.org) `javax.jms.ConnectionFactory`. If you wanted to connect to traditional, non-embedded instances, it's straightforward to either specify properties in `application.yml` or `application.properties` like `spring.hornetq.host` or simply define `@Bean`s of the appropriate type.
...
## [](#spring-boot-12-choice-and-power)Spring Boot 1.2: Choice *and* Power

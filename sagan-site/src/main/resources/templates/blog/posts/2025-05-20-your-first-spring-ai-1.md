---
title: Your First Spring AI 1.0 Application
source: https://spring.io/blog/2025/05/20/your-first-spring-ai-1
scraped: 2026-02-23T07:41:40.903Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Josh Long |  May 20, 2025 | 6 Comments
---

# Your First Spring AI 1.0 Application

_Engineering | Josh Long |  May 20, 2025 | 6 Comments_

# [](#your-first-spring-ai-10-application)Your First Spring AI 1.0 Application
...
## [](#the-pains-and-patterns-of-ai-engineering)the Pains and Patterns of AI Engineering
...
## [](#one-small-step-for-spring-developers-one-giant-leap-for-ai)One Small Step for Spring Developers, One Giant Leap for AI
...
```
Copyhttp :8080/jlong/assistant question=="my name is Josh" 
```
...
```
Copyhttp :8080/jlong/assistant question=="what's my name?" 
```
...
```shell
Copyhttp :8080/jlong/assistant question=="do you have any neurotic dogs?"
```

We're hoping the model will know about our friend *Prancer*. It will return, alas, that it does not.

## [](#avoid-token-bankruptcy-with-good-observability)Avoid Token Bankruptcy with Good Observability
...
```properties
Copymanagement.endpoints.web.exposure.include=*
...
## [](#retrieval-augmented-generation-rag-with-vector-stores)Retrieval Augmented Generation (R.A.G.) with Vector Stores
...
```java
Copyrecord DogAdoptionSuggestion(int id,String name, String description) {}
```
...
```shell
Copyhttp :8080/jlong/assistant question=="fantastic. when can i schedule an appointment to pickup Prancer from the New York City location?"
```
...
```properties
Copyspring.ai.mcp.client.stdio.servers-configuration=classpath:/github-mcp.json
```
...
## [](#the-chatbox-is-the-new-ux)The Chatbox Is the New UX
...
## [](#production-worthy-ai)Production Worthy AI

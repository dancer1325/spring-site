...
source: https://spring.io/blog/2025/10/30/spring-ai-bedrock-prompt-caching-blog
scraped: 2026-02-23T07:23:49.850Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Soby Chacko |  October 30, 2025 | 0 Comments
---

# AWS Bedrock Prompt Caching Support in Spring AI

_Engineering | Soby Chacko |  October 30, 2025 | 0 Comments_
...
## [](#what-aws-bedrock-adds)What AWS Bedrock Adds
...
## [](#key-differences-from-anthropic-direct-api)Key Differences from Anthropic Direct API
...
### [](#fixed-5-minute-cache-ttl)Fixed 5-Minute Cache TTL
...
```java
Copy// Anthropic direct API: optional TTL configuration
...
### [](#tool-caching-not-supported-on-nova)Tool Caching Not Supported on Nova
...
### [](#model-specific-token-thresholds)Model-Specific Token Thresholds

Model

Minimum Tokens per Checkpoint

Claude 3.7 Sonnet, 3.5 Sonnet v2, Opus 4, Sonnet 4, Sonnet 4.5
...
### [](#cache-metrics-naming)Cache Metrics Naming
...
## [](#same-spring-ai-patterns-across-providers)Same Spring AI Patterns Across Providers

Spring AI uses identical caching strategies across both providers:

```java
CopyBedrockCacheStrategy.SYSTEM_ONLY           ←→ AnthropicCacheStrategy.SYSTEM_ONLY
...
## [](#provider-characteristics-at-a-glance)Provider Characteristics at a Glance
...
5 minutes (default), 1 hour (optional)
...
~25% write premium, ~90% read savings

25% write premium, 90% read savings

## [](#example-document-analysis-with-caching)Example: Document Analysis with Caching
...
## [](#using-different-models-on-bedrock)Using Different Models on Bedrock
...
```properties
Copyspring.ai.bedrock.aws.region=us-east-1
...
## [](#strategy-selection-reference)Strategy Selection Reference
...
Large stable tools, dynamic system

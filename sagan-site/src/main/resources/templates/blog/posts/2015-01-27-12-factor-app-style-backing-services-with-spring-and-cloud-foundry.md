---
title: 12-Factor App-Style Backing Services with Spring and Cloud Foundry
source: https://spring.io/blog/2015/01/27/12-factor-app-style-backing-services-with-spring-and-cloud-foundry
scraped: 2026-02-23T21:58:45.386Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Josh Long |  January 27, 2015 | 1 Comment
---

# 12-Factor App-Style Backing Services with Spring and Cloud Foundry

_Engineering | Josh Long |  January 27, 2015 | 1 Comment_
...
## [](#a-simple-spring-boot-application-that-talks-to-a-jdbc-datasource)A Simple Spring Boot Application that talks to a JDBC `DataSource`
...
## [](#creating-and-binding-backing-services-in-cloud-foundry)Creating and Binding Backing Services in Cloud Foundry
...
```bash
Copycf create-service elephantsql turtle postgresql-db
```
...
## [](#cloud-foundrys-auto-reconfiguration)Cloud Foundry's Auto-Reconfiguration
...
## [](#useful-environment-properties-for-your-spring-application)Useful `Environment` properties for your Spring Application
...
```properties
Copyspring.jpa.generate-ddl=true
```

A sample `src/main/resources/application-cloud.properties`:

```properties
Copyspring.datasource.url=${cloud.services.postgresql-db.connection.jdbcurl}
```

A sample `src/main/resources/application-default.properties`:

```properties
Copy# empty in this case because I rely on the embedded H2 instance being created
# though you could point it to another, local,
# PostgresSQL instancefor dev workstation configuration
```

## [](#using-spring-cloud-paas-connectors)Using Spring Cloud PaaS connectors
...
## [](#using-java-configuration-beans)Using Java configuration `@Bean`s
...
Check [out the examples](https://github.com/joshlong/12factor-backing-services), too!
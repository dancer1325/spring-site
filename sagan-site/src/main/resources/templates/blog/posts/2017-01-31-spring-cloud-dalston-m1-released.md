---
title: Spring Cloud Dalston M1 Released
source: https://spring.io/blog/2017/01/31/spring-cloud-dalston-m1-released
scraped: 2026-02-23T18:39:54.589Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Spencer Gibb |  January 31, 2017 | 0 Comments
---

# Spring Cloud Dalston M1 Released

_Releases | Spencer Gibb |  January 31, 2017 | 0 Comments_

On behalf of the community, I am pleased to announce that Milestone 1 (M1) of the [Spring Cloud Dalston](https://cloud.spring.io) Release Train is available today. The release can be found in our [Spring Milestone](https://repo.spring.io/milestone/) repository. You can check out the Dalston [release notes for more information](https://github.com/spring-projects/spring-cloud/wiki/Spring-Cloud-Dalston-Release-Notes).

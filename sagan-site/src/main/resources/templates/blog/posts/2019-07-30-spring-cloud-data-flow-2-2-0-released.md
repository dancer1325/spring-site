...
source: https://spring.io/blog/2019/07/30/spring-cloud-data-flow-2-2-0-released
scraped: 2026-02-23T14:41:08.108Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Janne Valkealahti |  July 30, 2019 | 2 Comments
---

# Spring Cloud Data Flow 2.2.0 Released

_Releases | Janne Valkealahti |  July 30, 2019 | 2 Comments_
...
It is now possible to stop and delete task executions using the SCDF Dashboard and the Shell. We have added support for task application monitoring using micrometer integration. The core of the Micrometer integration landed in Spring Cloud Task's 2.2.0 release-line, which by the way is a requirement if you are going to try out the Task-metrics and the SCDF integration.

---
title: Using Spring Security 5 to integrate with OAuth 2-secured services such as Facebook and GitHub
source: https://spring.io/blog/2018/03/06/using-spring-security-5-to-integrate-with-oauth-2-secured-services-such-as-facebook-and-github
scraped: 2026-02-23T15:19:56.117Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Craig Walls |  March 06, 2018 | 32 Comments
---

# Using Spring Security 5 to integrate with OAuth 2-secured services such as Facebook and GitHub

_Engineering | Craig Walls |  March 06, 2018 | 32 Comments_
...
In this article, we’re going to look at how to develop a Spring Boot application that, using Spring Security 5, integrates with Facebook. You can find the complete code for this article at [https://github.com/habuma/facebook-security5](https://github.com/habuma/facebook-security5).

# [](#enabling-oauth-2-login)[](#enabling-oauth-2-login)Enabling OAuth 2 login
...
![FB Link](https://raw.githubusercontent.com/habuma/facebook-security5/master/article/images/FB_Link.png)
...
![FB Authorities](https://raw.githubusercontent.com/habuma/facebook-security5/master/article/images/FB_Authorities.png)
...
# [](#accessing-api-resources)[](#accessing-api-resources)Accessing API resources
...
```
CopyOAuth2AuthorizedClient client =
...
```
Copypublic abstract class ApiBinding {
...
```
Copypublic class Facebook extends ApiBinding {
...
Also, because the `getFeed()` method from the `Facebook` API binding fetches data from the user’s feed, we’ll need to set `spring.security.oauth2.client.registration.facebook.scope` to specify "user\_posts" scope when authenticating the user:
...
# [](#a-more-flexible-api-binding)[](#a-more-flexible-api-binding)A more flexible API binding
...
```
Copypublic abstract class ReactiveApiBinding {

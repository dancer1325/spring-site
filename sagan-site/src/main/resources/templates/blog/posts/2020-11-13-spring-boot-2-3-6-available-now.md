---
title: Spring Boot 2.3.6 available now
source: https://spring.io/blog/2020/11/13/spring-boot-2-3-6-available-now
scraped: 2026-02-23T13:41:44.773Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Stéphane Nicoll |  November 13, 2020 | 1 Comment
---

# Spring Boot 2.3.6 available now

_Releases | Stéphane Nicoll |  November 13, 2020 | 1 Comment_
...
This release includes [30 bug fixes, documentation improvements, and dependency upgrades](https://github.com/spring-projects/spring-boot/releases/tag/v2.3.6.RELEASE). Thanks to all those who have contributed with issue reports and pull requests.
...
[Project Page](https://spring.io/projects/spring-boot/) | [GitHub](https://github.com/spring-projects/spring-boot) | [Issues](https://github.com/spring-projects/spring-boot/issues) | [Documentation](http://docs.spring.io/spring-boot/docs/2.3.6.RELEASE/reference/html) | [Stack Overflow](http://stackoverflow.com/questions/tagged/spring-boot) | [Gitter](https://gitter.im/spring-projects/spring-boot)
...
source: https://spring.io/blog/2025/09/30/spring-ai-mcp-server-security
scraped: 2026-02-23T07:28:18.103Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Daniel Garnier-Moiroux |  September 30, 2025 | 2 Comments
---

# Securing MCP Servers with Spring AI

_Engineering | Daniel Garnier-Moiroux |  September 30, 2025 | 2 Comments_
...
## [](#securing-mcp-servers-with-oauth-2)Securing MCP Servers with OAuth 2
...
```groovy
Copyimplementation("org.springframework.ai:spring-ai-starter-mcp-server-webmvc")
...
```properties
Copyspring.ai.mcp.server.name=my-cool-mcp-server
...
```shell
Copycurl http://localhost:8080/.well-known/oauth-protected-resource/mcp
#
# Will print out:
#
# {
...
```shell
Copynpx @modelcontextprotocol/inspector@0.16.7
```
...
## [](#mcp-compatible-spring-authorization-server)MCP-compatible Spring Authorization Server
...
```groovy
Copyimplementation("org.springaicommunity:mcp-authorization-server:0.0.3")
```
...
## [](#beyond-oauth-2-api-keys)Beyond OAuth 2: API keys
...
## [](#improving-mcp-security)Improving MCP security

---
title: Spring Boot 3.0.2 available now
source: https://spring.io/blog/2023/01/19/spring-boot-3-0-2-available-now
scraped: 2026-02-23T10:15:32.976Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Phil Webb |  January 19, 2023 | 3 Comments
---

# Spring Boot 3.0.2 available now

_Releases | Phil Webb |  January 19, 2023 | 3 Comments_
...
This release includes [66 bug fixes, documentation improvements, and dependency upgrades](https://github.com/spring-projects/spring-boot/releases/tag/v3.0.2). Thanks to all those who have contributed with issue reports and pull requests.

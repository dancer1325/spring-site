...
source: https://spring.io/blog/2025/11/04/spring-ai-recursive-advisors
scraped: 2026-02-23T07:23:21.277Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  November 04, 2025 | 0 Comments
---

# Create Self-Improving AI Agents Using Spring AI Recursive Advisors

_Engineering | Christian Tzolov |  November 04, 2025 | 0 Comments_
...
```java
Copypublic class MyAdvisor implements CallAdvisor {
...
## [](#recursive-advisors)Recursive Advisors
...
```java
Copypublic class MyRecursiveAdvisor implements CallAdvisor {
...
> #### [](#%EF%B8%8F-important-note)⚠️ Important Note
> 
...
## [](#built-in-recursive-advisors)Built-in Recursive Advisors

Spring AI 1.1.0-M4 provides two recursive advisors:

### [](#toolcalladvisor)[ToolCallAdvisor](https://docs.spring.io/spring-ai/reference/1.1.1/api/advisors-recursive.html#_toolcalladvisor)
...
```java
Copyvar toolCallAdvisor = ToolCallAdvisor.builder()
...
### [](#structuredoutputvalidationadvisor)[StructuredOutputValidationAdvisor](https://docs.spring.io/spring-ai/reference/1.1.1/api/advisors-recursive.html#_structuredoutputvalidationadvisor)
...
```java
Copypublic record ActorFilms(String actor, List<String> movies) {}

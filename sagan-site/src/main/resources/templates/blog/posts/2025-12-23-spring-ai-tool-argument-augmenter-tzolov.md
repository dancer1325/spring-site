...
source: https://spring.io/blog/2025/12/23/spring-ai-tool-argument-augmenter-tzolov
scraped: 2026-02-22T22:04:29.877Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  December 23, 2025 | 1 Comment
---

# Explainable AI Agents: Capture LLM Tool Call Reasoning with Spring AI

_Engineering | Christian Tzolov |  December 23, 2025 | 1 Comment_
...
#### [](#the-tool-argument-augmenter-solution)The Tool Argument Augmenter Solution
...
#### [](#1-define-augmented-arguments)1\. Define Augmented Arguments
...
```java
Copyimport org.springframework.ai.tool.annotation.ToolParam;
...
#### [](#2-wrap-your-existing-tools)2\. Wrap Your Existing Tools

Use the `AugmentedToolCallbackProvider` builder to wrap your existing tools:

```java
Copyimport org.springframework.ai.tool.augment.AugmentedToolCallbackProvider;
...
#### [](#3-wrap-your-existing-toolcallbackproviders)3\. Wrap Your Existing ToolCallbackProviders

You can wrap existing providers (including `MCP` tool providers) instead of individual tool objects:

```java
CopyAugmentedToolCallbackProvider<AgentThinking> provider = 
    AugmentedToolCallbackProvider.<AgentThinking>builder()
...
#### [](#4-what-the-llm-sees)4\. What the LLM Sees
...
#### [](#5-llm-response-with-reasoning)5\. LLM Response with Reasoning
...
#### [](#6-include-reasoning-in-final-response-optional)6\. Include Reasoning in Final Response (Optional)
...
```java
Copypublic record ResponseWithReasoning(
    String response, 
...
```java
Copypublic record ChainOfThought(
...
```java
Copypublic record ToolAnalytics(
...
```java
Copypublic record AgentCoordination(

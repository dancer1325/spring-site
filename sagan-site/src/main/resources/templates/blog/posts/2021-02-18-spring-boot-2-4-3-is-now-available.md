---
title: Spring Boot 2.4.3 is now available
source: https://spring.io/blog/2021/02/18/spring-boot-2-4-3-is-now-available
scraped: 2026-02-23T13:31:04.307Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Andy Wilkinson |  February 18, 2021 | 0 Comments
---

# Spring Boot 2.4.3 is now available

_Releases | Andy Wilkinson |  February 18, 2021 | 0 Comments_
...
This release includes [75 bug fixes, documentation improvements, and dependency upgrades](https://github.com/spring-projects/spring-boot/releases/tag/v2.4.3). Thanks to all those who have contributed with issue reports and pull requests.
...
[Project Page](https://spring.io/projects/spring-boot/) | [GitHub](https://github.com/spring-projects/spring-boot) | [Issues](https://github.com/spring-projects/spring-boot/issues) | [Documentation](http://docs.spring.io/spring-boot/docs/2.4.3/reference/html) | [Stack Overflow](http://stackoverflow.com/questions/tagged/spring-boot) | [Gitter](https://gitter.im/spring-projects/spring-boot)
---
title: Hello, Java 21
source: https://spring.io/blog/2023/09/20/hello-java-21
scraped: 2026-02-23T09:22:52.677Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Josh Long |  September 20, 2023 | 18 Comments
---

# Hello, Java 21

_Engineering | Josh Long |  September 20, 2023 | 18 Comments_
...
## [](#why-graalvm-instead-of-plain-ol-java)Why GraalVM instead of plain ol' Java?
...
### [](#enhanced-switch)Enhanced Switch
...
### [](#the-enhanced-instanceof-check)The Enhanced `instanceof` Check
...
### [](#next-level-pattern-matching-with-records-switch-and-if)Next Level Pattern Matching with `records`, `switch`, and `if.`
...
### [](#improved-mathematics)Improved mathematics
...
### [](#autocloseable-http-client)AutoCloseable HTTP Client
...
### [](#string-enhancements)String Enhancements
...
### [](#virtual-threads-and-project-loom)Virtual Threads and Project Loom

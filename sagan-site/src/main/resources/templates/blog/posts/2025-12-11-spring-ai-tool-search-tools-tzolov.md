...
source: https://spring.io/blog/2025/12/11/spring-ai-tool-search-tools-tzolov
scraped: 2026-02-22T22:05:29.321Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  December 11, 2025 | 1 Comment
---

# Smart Tool Selection: Achieving 34-64% Token Savings with Spring AI's Dynamic Tool Discovery

_Engineering | Christian Tzolov |  December 11, 2025 | 1 Comment_
...
## [](#the-tool-search-tool-solution)The Tool Search Tool Solution
...
```java
Copyvar toolSearchToolCallAdvisor = ToolSearchToolCallAdvisor.builder()
...
### [](#pluggable-search-strategies)Pluggable Search Strategies
...
#### [](#results-with-lucene-search)Results with Lucene Search
...
#### [](#results-with-vectorstore-search)Results with VectorStore Search

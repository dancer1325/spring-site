---
title: "Wiremock" for RSocket
source: https://spring.io/blog/2021/06/02/wiremock-for-rsocket
scraped: 2026-02-23T13:21:48.042Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Dave Syer |  June 02, 2021 | 1 Comment
---

# "Wiremock" for RSocket

_Engineering | Dave Syer |  June 02, 2021 | 1 Comment_

If you have an application that connects to an [RSocket](https://rsocket.io) server at runtime, how do you test it? We need a way for a test to start a server and tell us where it is listening, and then we need to be able to register request and response examples (a.k.a. "contracts"). That’s what this [project](https://github.com/dsyer/rsocket-test-server) provides - it’s like Wiremock but for RSocket.
...
```
Copy@SpringBootTest("rsocket.port=${test.rsocket.server.port}")
@ExtendWith(RSocketServerExtension.class)
class SocketsApplicationTests {
	...
}
...
## [](#defining-message-mappings-in-json)[](#defining-message-mappings-in-json)Defining message mappings in JSON
...
## [](#manipulating-and-inspecting-the-message-catalog)[](#manipulating-and-inspecting-the-message-catalog)Manipulating and inspecting the message catalog

---
title: Spring AI Agentic Patterns (Part 3): Why Your AI Agent Forgets Tasks (And How to Fix It)
source: https://spring.io/blog/2026/01/20/spring-ai-agentic-patterns-3-todowrite
scraped: 2026-02-22T22:01:19.332Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  January 20, 2026 | 1 Comment
---

# Spring AI Agentic Patterns (Part 3): Why Your AI Agent Forgets Tasks (And How to Fix It)

_Engineering | Christian Tzolov |  January 20, 2026 | 1 Comment_
...
## [](#what-is-todowritetool)What Is TodoWriteTool?
...
```
CopyProgress: 2/4 tasks completed (50%)
...
### [](#how-the-llm-knows-when-to-use-it)How the LLM Knows When to Use It
...
### [](#3-optional-event-driven-progress-updates)3\. (Optional) Event-Driven Progress Updates
...
```java
Copypublic class TodoUpdateEvent extends ApplicationEvent {

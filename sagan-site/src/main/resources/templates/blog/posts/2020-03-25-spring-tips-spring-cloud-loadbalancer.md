...
source: https://spring.io/blog/2020/03/25/spring-tips-spring-cloud-loadbalancer
scraped: 2026-02-23T14:06:37.979Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Josh Long |  March 25, 2020 | 16 Comments
---

# Spring Tips: Spring Cloud Loadbalancer

_Engineering | Josh Long |  March 25, 2020 | 16 Comments_
...
```java
Copypackage com.example.eurekaservice;
...
## [](#the-load-balancing-client)The Load-Balancing Client
...
```java
Copypackage com.example.client;
...
### [](#using-the-loadbalancer-abstraction-directly)Using the Loadbalancer Abstraction Directly
...
### [](#using-the-reactorloadbalancerexchangefilterfunction)Using the `ReactorLoadBalancerExchangeFilterFunction`
...
### [](#the-loadbalanced-annotation)The `@LoadBalanced` Annotation

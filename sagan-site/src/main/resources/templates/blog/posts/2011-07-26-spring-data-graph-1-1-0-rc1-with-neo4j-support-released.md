---
title: Spring Data Graph 1.1.0.RC1 with Neo4j support Released
source: https://spring.io/blog/2011/07/26/spring-data-graph-1-1-0-rc1-with-neo4j-support-released
scraped: 2026-02-24T08:37:57.693Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Thomas Risberg |  July 26, 2011 | 0 Comments
---

# Spring Data Graph 1.1.0.RC1 with Neo4j support Released

_Releases | Thomas Risberg |  July 26, 2011 | 0 Comments_
...
Project resources: [Downloads](http://www.springsource.com/download/community?project=Spring%20Data%20Neo4j) | [JavaDocs](http://static.springsource.org/spring-data/data-graph/docs/1.1.0.RC1/api/) | [Spring Data Graph Guide Book](http://static.springsource.org/spring-data/data-graph/docs/1.1.0.RC1/reference/html/) | [Changelog](http://static.springframework.org/spring-data/data-graph/docs/1.1.0.RC1/changelog.txt)
---
title: Spring AI Agentic Patterns (Part 2): AskUserQuestionTool - Agents That Clarify Before Acting
source: https://spring.io/blog/2026/01/16/spring-ai-ask-user-question-tool
scraped: 2026-02-22T22:01:54.513Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  January 16, 2026 | 0 Comments
---

# Spring AI Agentic Patterns (Part 2): AskUserQuestionTool - Agents That Clarify Before Acting

_Engineering | Christian Tzolov |  January 16, 2026 | 0 Comments_
...
## [](#how-askuserquestiontool-works)How AskUserQuestionTool Works
...
### [](#example-travel-recommendation-assistant)Example: Travel Recommendation Assistant
...
```
CopyUSER: What EU country to visit next?
...
```java
CopyChatClient chatClient = chatClientBuilder
...
### [](#questionhandler-examples)QuestionHandler Examples

#### [](#console-based-questionhandler)Console-Based QuestionHandler

A console-based implementation:

```java
Copyprivate static Map<String, String> handleQuestions(List<Question> questions) {
...
#### [](#web-based-questionhandler)Web-Based QuestionHandler

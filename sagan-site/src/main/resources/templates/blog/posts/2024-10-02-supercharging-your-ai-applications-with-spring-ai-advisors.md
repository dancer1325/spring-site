...
source: https://spring.io/blog/2024/10/02/supercharging-your-ai-applications-with-spring-ai-advisors
scraped: 2026-02-23T08:14:19.325Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  October 02, 2024 | ...
---

# Supercharging Your AI Applications with Spring AI Advisors

_Engineering | Christian Tzolov |  October 02, 2024 | ..._
...
## [](#what-are-spring-ai-advisors)What are Spring AI Advisors?
...
## [](#how-advisors-work)How Advisors Work
...
```java
Copyvar chatClient = ChatClient.builder(chatModel)
    .defaultAdvisors(
...
## [](#implementing-your-own-advisor)Implementing Your Own Advisor
...
#### [](#simple-logging-advisor)Simple Logging Advisor

Creating a custom Advisor is straightforward. Let's implement a simple logging Advisor to demonstrate the process:

```java
Copypublic class SimpleLoggerAdvisor implements CallAroundAdvisor, StreamAroundAdvisor {
...
#### [](#re-reading-re2-advisor)Re-Reading (Re2) Advisor
...
```java
Copypublic class ReReadingAdvisor implements CallAroundAdvisor, StreamAroundAdvisor {
...
### [](#controlling-advisor-order)Controlling Advisor Order
...
### [](#using-advisorcontext-for-state-sharing)Using AdvisorContext for State Sharing

...
source: https://spring.io/blog/2024/09/26/ai-meets-spring-petclinic-implementing-an-ai-assistant-with-spring-ai-part-i
scraped: 2026-02-23T08:14:54.757Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Oded Shopen |  September 26, 2024 | 2 Comments
---

# AI Meets Spring Petclinic: Implementing an AI Assistant with Spring AI (Part I)

_Engineering | Oded Shopen |  September 26, 2024 | 2 Comments_
...
## [](#introduction-to-spring-petclinic)Introduction to Spring Petclinic
...
```xml
Copy<table id="vets" class="table table-striped">
  <thead>
  <tr>
    <th>Name</th>
    <th>Specialties</th>
...
```java
Copy	private String addPaginationModel(int page, Page<Vet> paginated, Model model) {
...
## [](#hello-spring-ai)Hello, Spring AI
...
## [](#considerations-for-implementing-ai-in-spring-petclinic)Considerations for implementing AI in Spring Petclinic
...
### [](#selecting-a-model-api)**Selecting a Model API**
...
### [](#selecting-a-large-language-model-provider)Selecting a Large Language Model provider
...
## [](#lets-get-coding)Let's get coding!
...
#### [](#a-simple-chatclient)A Simple ChatClient:

Here’s a barebones, unaltered `ChatClient` bean definition:

```java
Copy	public PetclinicChatClient(ChatClient.Builder builder) {
...
#### [](#a-chatclient-with-better-memory)A ChatClient with better memory
...
```java
Copy 	public PetclinicChatClient(ChatClient.Builder builder, ChatMemory chatMemory) {
		// @formatter:off
...
#### [](#a-chatclient-bound-to-a-specific-domain)**A ChatClient Bound to a Specific Domain**
...
## [](#identifying-core-functionality)Identifying Core Functionality
...
#### [](#adding-a-pet-to-an-existing-owner)**Adding a Pet to an Existing Owner**
...
## [](#function-calling-with-spring-ai)Function Calling with Spring AI
...
```java
Copy  public OwnersResponse getAllOwners() {
...
#### [](#add-pet-to-owner)Add Pet to Owner
...
```java
Copyrecord AddPetRequest(Pet pet, String petType, Integer ownerId) {
};
...
```java
Copy	public AddedPetResponse addPetToOwner(AddPetRequest request) {
...
```java
Copy// These are the original insert queries in data.sql
...
```java
Copy	public OwnerResponse addOwnerToPetclinic(OwnerRequest ownerRequest) {

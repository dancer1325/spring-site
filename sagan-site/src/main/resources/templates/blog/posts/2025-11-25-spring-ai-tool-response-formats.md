...
source: https://spring.io/blog/2025/11/25/spring-ai-tool-response-formats
scraped: 2026-02-22T22:09:02.031Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  November 25, 2025 | 0 Comments
---

# Beyond JSON: Converting Spring AI Tool Response Formats to TOON, XML, CSV, YAML, ...

_Engineering | Christian Tzolov |  November 25, 2025 | 0 Comments_
...
## [](#spring-ai-tool-calling-a-quick-overview)Spring AI Tool Calling: A Quick Overview
...
## [](#approach-1-custom-toolcallresultconverter-configuration)Approach 1: Custom ToolCallResultConverter Configuration
...
```java
Copypublic static class ToonToolCallResultConverter implements ToolCallResultConverter {
...
```java
Copy@Tool(description = "Get random titanic passengers", 
...
## [](#approach-2-global-tool-response-configuration)Approach 2: Global Tool Response Configuration
...
```
CopyOriginal ToolCallbackProvider
    ↓ wrapped by
...
#### [](#component-1-delegatortoolcallbackprovider)Component 1: [DelegatorToolCallbackProvider](https://github.com/tzolov/spring-ai-tool-response-format-demo/blob/main/src/main/java/com/example/trfd/DelegatorToolCallbackProvider.java)

```java
Copypublic class DelegatorToolCallbackProvider implements ToolCallbackProvider {
...
#### [](#component-2-delegatortoolcallback)Component 2: [DelegatorToolCallback](https://github.com/tzolov/spring-ai-tool-response-format-demo/blob/370bb149c4fcfa83c4f9d117879bbdf18c0d2e71/src/main/java/com/example/trfd/DelegatorToolCallbackProvider.java#L47)

```java
Copypublic static class DelegatorToolCallback implements ToolCallback {
...
#### [](#component-3-responseconverter-utility)Component 3: [ResponseConverter](https://github.com/tzolov/spring-ai-tool-response-format-demo/blob/main/src/main/java/com/example/trfd/ResponseConverter.java) Utility

```java
Copypublic class ResponseConverter {
...
```json
Copy[{"PassengerId":"31","Survived":"0","Pclass":"1","Name":"Uruchurtu, Don. Manuel E","Sex":"male","Age":40,"SibSp":"0","Parch":"0","Ticket":"PC 17601","Fare":27.7208,"Cabin":null,"Embarked":"C"},
...
```toon
Copy[5]{PassengerId,Survived,Pclass,Name,Sex,Age,SibSp,Parch,Ticket,Fare,Cabin,Embarked}:
...
```csv
CopyPassengerId,Survived,Pclass,Name,Sex,Age,SibSp,Parch,Ticket,Fare,Cabin,Embarked
...
```bash
Copy./mvnw spring-boot:run -Dspring.ai.tool.response.format=TOON

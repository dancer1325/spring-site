---
title: An Azure Spring Cloud Update: Managed Virtual Network and Autoscale are now generally available in Azure Spring Cloud
source: https://spring.io/blog/2021/03/18/an-azure-spring-cloud-update-managed-virtual-network-and-autoscale-are-now-generally-available-in-azure-spring-cloud
scraped: 2026-02-23T13:29:01.540Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Josh Long |  March 18, 2021 | 0 Comments
---

# An Azure Spring Cloud Update: Managed Virtual Network and Autoscale are now generally available in Azure Spring Cloud

_Engineering | Josh Long |  March 18, 2021 | 0 Comments_

> NOTE: this post was written by our friend [Kylie Liang (@liangkylie)](https://twitter.com/liangkylie?lang=en) from the Microsoft Azure Spring Cloud team. Thanks, Kylie!
...
## [](#secure-azure-spring-cloud-in-managed-virtual-network)Secure Azure Spring Cloud in Managed Virtual Network
...
![Figure 1](https://github.com/kyliel/AzureSpringCloudBlog/raw/master/Images-vnet-autoscaler-ga_202103/Figure1_VNET.png) Figure 1: Azure Spring Cloud in a managed virtual network with custom route table
...
![Figure 2](https://github.com/kyliel/AzureSpringCloudBlog/raw/master/Images-vnet-autoscaler-ga_202103/Figure2_VNET.PNG) Figure 2: Diagnostics page to diagnose issue such as networking connectivity

![Figure 3](https://github.com/kyliel/AzureSpringCloudBlog/raw/master/Images-vnet-autoscaler-ga_202103/Figure3_VNET.png)  
...
## [](#dynamically-scale-your-azure-spring-cloud-apps-to-meet-changing-demands)Dynamically Scale your Azure Spring Cloud Apps to meet changing demands
...
![Figure 4](https://github.com/kyliel/AzureSpringCloudBlog/raw/master/Images-vnet-autoscaler-ga_202103/Figure4_Scale.png) Figure 4: Metrics with upscaling and downscaling
...
In Azure Spring Cloud, an *App* is an abstraction of one business app or one microservice. One version of code or binary deployed as the *App* runs in a *Deployment*. You can have one active deployment for production and the other deployment for staging. You can configure the Autoscale setting for each deployment.

![Figure 5](https://github.com/kyliel/AzureSpringCloudBlog/raw/master/Images-vnet-autoscaler-ga_202103/Figure5_Scale.PNG)  
...
```Terraform
Copyresource "azurerm_monitor_autoscale_setting" "test" {

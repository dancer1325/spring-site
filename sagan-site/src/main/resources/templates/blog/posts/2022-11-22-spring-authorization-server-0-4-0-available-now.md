---
title: Spring Authorization Server 0.4.0 available now
source: https://spring.io/blog/2022/11/22/spring-authorization-server-0-4-0-available-now
scraped: 2026-02-23T10:30:46.923Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Joe Grandja |  November 22, 2022 | 0 Comments
---

# Spring Authorization Server 0.4.0 available now

_Releases | Joe Grandja |  November 22, 2022 | 0 Comments_
...
```
Copyimplementation 'org.springframework.security:spring-security-oauth2-authorization-server:0.4.0'
```

See the [release notes](https://github.com/spring-projects/spring-authorization-server/releases/tag/0.4.0) for complete details.

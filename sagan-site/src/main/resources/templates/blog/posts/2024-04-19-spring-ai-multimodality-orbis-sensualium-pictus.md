...
source: https://spring.io/blog/2024/04/19/spring-ai-multimodality-orbis-sensualium-pictus
scraped: 2026-02-23T08:45:06.570Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  April 19, 2024 | 0 Comments
---

# Spring AI - Multimodality - Orbis Sensualium Pictus

_Engineering | Christian Tzolov |  April 19, 2024 | 0 Comments_
...
# [](#spring-ai---multimodality)Spring AI - Multimodality
...
```
Copybyte[] imageData = new ClassPathResource("/multimodal.test.png").getContentAsByteArray();
...
```
CopyString response = ChatClient.create(chatModel).prompt()

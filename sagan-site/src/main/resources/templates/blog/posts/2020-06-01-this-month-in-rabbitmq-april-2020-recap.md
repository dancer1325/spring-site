---
title: This Month in RabbitMQ, April 2020 Recap | RabbitMQ
source: https://www.rabbitmq.com/blog/2020/06/01/this-month-in-rabbitmq-april-2020-recap/
scraped: 2026-02-23T13:59:19.586Z
description: A Webinar on Quorum Queues
---

# This Month in RabbitMQ, April 2020 Recap | RabbitMQ

### A Webinar on Quorum Queues[​](#a-webinar-on-quorum-queues "Direct link to A Webinar on Quorum Queues")

Before we start with RabbitMQ project and community updates from April, we have a webinar to announce! Jack Vanlightly, a RabbitMQ core team member, will present on [High Availability and Data Safety in Messaging](https://www.brighttalk.com/webcast/14891/412069) on June 11th, 2020.

In this webinar, Jack Vanlightly will explain [quorum queues](/docs/quorum-queues), a new replicated queue type in RabbitMQ. Quorum queues were introduced in RabbitMQ 3.8 with a focus on data safety and efficient, predictable recovery from node failures. Jack will cover and contrast the design of quorum and classic mirrored queues.
...
-   [Erlang 23](http://blog.erlang.org/OTP-23-Highlights/) includes an important improvement for container users: the runtime now takes CPU quotas into account when computing how many [runtime schedulers](/docs/runtime) to start
...
## Community Writings[​](#community-writings "Direct link to Community Writings")

---
title: Spring Authorization Server 1.5.0-RC1, 1.4.3 and 1.3.6 available now
source: https://spring.io/blog/2025/04/23/spring-authorization-server-1-5-0-RC1-1-4-3-and-1-3-6-available-now
scraped: 2026-02-23T07:44:41.857Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Joe Grandja |  April 23, 2025 | 0 Comments
---

# Spring Authorization Server 1.5.0-RC1, 1.4.3 and 1.3.6 available now

_Releases | Joe Grandja |  April 23, 2025 | 0 Comments_
...
See the [1.5.0-RC1](https://github.com/spring-projects/spring-authorization-server/releases/tag/1.5.0-RC1), [1.4.3](https://github.com/spring-projects/spring-authorization-server/releases/tag/1.4.3) and [1.3.6](https://github.com/spring-projects/spring-authorization-server/releases/tag/1.3.6) release notes for complete details.

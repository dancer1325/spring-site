---
title: Spring Authorization Server 1.1.0-M2 available now
source: https://spring.io/blog/2023/03/21/spring-authorization-server-1-1-0-m2-available-now
scraped: 2026-02-23T10:01:03.755Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Steve Riesenberg |  March 21, 2023 | 0 Comments
---

# Spring Authorization Server 1.1.0-M2 available now

_Releases | Steve Riesenberg |  March 21, 2023 | 0 Comments_
...
The main feature delivered in this release is support for OAuth 2.0 Device Authorization Grant ([gh-1106](https://github.com/spring-projects/spring-authorization-server/pull/1106)).

See the [release notes](https://github.com/spring-projects/spring-authorization-server/releases/tag/1.1.0-M2) for complete details.

...
source: https://spring.io/blog/2024/03/15/hypermedia-and-browser-enhancement
scraped: 2026-02-23T08:51:38.968Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Dave Syer |  March 15, 2024 | 5 Comments
---

# Hypermedia and Browser Enhancement

_Engineering | Dave Syer |  March 15, 2024 | 5 Comments_
...
![Home Page](https://static.spring.io/blog/contentful/20240923/home.jpg)

and one with a form that the user can submit to create a greeting:

```java
Copy@PostMapping(path = "/greet")
...
![Greet Form](https://static.spring.io/blog/contentful/20240923/greet.jpg)
...
```html
Copy<script src='https://unpkg.com/htmx.org/dist/htmx.min.js'></script>
```
...
```html
Copy<form th:action="@{/greet}" method="post" hx-post="/greet">
...
```html
Copy<form th:action="@{/greet}" th:hx-post="@{/greet}" method="post" hx-target="#content">
```
...
```html
Copy<div id="content" class="col-md-12" hx-swap-oob="true">
...
![Greet Page](https://static.spring.io/blog/contentful/20240923/page.jpg)
...
### [](#using-a-fragment-template)Using a Fragment Template
...
```html
Copy<div id="content" th:fragment="content" class="col-md-12" hx-swap-oob="true">
	<span th:text="${greeting}">Hello, World</span><br/>
	<span th:text="${time}">21:00</span>
</div>
```
...
```java
Copy@PostMapping(path = "/greet", headers = "hx-request=true")
...
![Greet Fragment](https://static.spring.io/blog/contentful/20240923/network.jpg)
...
```html
Copy<div class="row" th:remove="all">
...
### [](#spring-boot-htmx)Spring Boot HTMX
...
```html
Copy<script src='https://unpkg.com/unpoly/unpoly.min.js'></script>
```

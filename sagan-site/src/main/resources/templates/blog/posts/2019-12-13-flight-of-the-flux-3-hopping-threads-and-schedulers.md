---
title: Flight of the Flux 3 - Hopping Threads and Schedulers
source: https://spring.io/blog/2019/12/13/flight-of-the-flux-3-hopping-threads-and-schedulers
scraped: 2026-02-23T14:18:26.263Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Simon Baslé |  December 13, 2019 | 13 Comments
---

# Flight of the Flux 3 - Hopping Threads and Schedulers

_Engineering | Simon Baslé |  December 13, 2019 | 13 Comments_
...
## [](#the-scheduler-abstraction)The `Scheduler` abstraction
...
```java
Copyinterface Scheduler extends Disposable {
...
### [](#are-schedulers-always-backed-by-an-executorservice)Are Schedulers Always Backed by an ExecutorService?
...
## [](#applying-schedulers-to-operators)Applying Schedulers to Operators
...
### [](#the-publishonscheduler-s-operator)The `publishOn(Scheduler s)` operator
...
```java
CopyFlux.fromIterable(firstListOfUrls) //contains A, B and C
...
```
Copymain from first list, got A
...
```
CopyboundedElastic-1 from first list, got A
...
### [](#the-subscribeonscheduler-s-operator)The `subscribeOn(Scheduler s)` operator
...
```java
Copy//code provided in library you have no write access to
...
```java
Copyfinal Flux<String> betterFetchUrls(List<String> urls) {
  return Flux.fromIterable(urls)
    .flatMap(url -> 
...
### [](#and-what-if-i-mix-the-two)And What If I Mix the Two?

---
title: Prompt Engineering Techniques with Spring AI
source: https://spring.io/blog/2025/04/14/spring-ai-prompt-engineering-patterns
scraped: 2026-02-23T07:47:08.764Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  April 14, 2025 | 1 Comment
---

# Prompt Engineering Techniques with Spring AI

_Engineering | Christian Tzolov |  April 14, 2025 | 1 Comment_
...
![](https://raw.githubusercontent.com/spring-projects/spring-ai-examples/refs/heads/main/prompt-engineering/prompt-engineering-patterns/prompt-engineering-spring-ai.png)
...
For prompt engineering, you will start by choosing a model. Spring AI supports [multiple LLM providers](https://docs.spring.io/spring-ai/reference/api/chat/comparison.html) (such as OpenAI, Anthropic, Google Vertex AI, AWS Bedrock, Ollama, and more), letting you switch providers without changing application code—just update your configuration. Just add the selected starter dependency `spring-ai-starter-model-<MODEL-PROVIDER-NAME>`. For example, here is how to enable Anthropic Claude API:
...
along with some connection properties: `spring.ai.anthropic.api-key=${ANTHROPIC_API_KEY}`

You can specify a particular LLM model name like this:

```java
Copy.options(ChatOptions.builder()
...
![](https://docs.spring.io/spring-ai/reference/_images/chat-options-flow.jpg)
...
#### [](#output-length-maxtokens)Output Length (MaxTokens)
...
#### [](#sampling-controls-top-k-and-top-p)Sampling Controls (Top-K and Top-P)
...
```java
Copy// Using OpenAI-specific options
...
### [](#21-zero-shot-prompting)2.1 Zero-Shot Prompting
...
```java
Copy// Implementation of Section 2.1: General prompting / zero shot (page 15)
...
### [](#22-one-shot--few-shot-prompting)2.2 One-Shot & Few-Shot Prompting
...
```java
Copy// Implementation of Section 2.2: One-shot & few-shot (page 16)
...
### [](#23-system-contextual-and-role-prompting)2.3 System, contextual and role prompting
...
```java
Copy// Implementation of Section 2.3.1: System prompting
...
```java
Copy// Implementation of Section 2.3.1: System prompting with JSON output
...
```java
Copy// Implementation of Section 2.3.2: Role prompting
...
```java
Copy// Implementation of Section 2.3.2: Role prompting with style instructions
...
```java
Copy// Implementation of Section 2.3.3: Contextual prompting
...
### [](#24-step-back-prompting)2.4 Step-Back Prompting
...
```java
Copy// Implementation of Section 2.4: Step-back prompting
...
### [](#25-chain-of-thought-cot)2.5 Chain of Thought (CoT)
...
```java
Copy// Implementation of Section 2.5: Chain of Thought (CoT) - Zero-shot approach
...
### [](#26-self-consistency)2.6 Self-Consistency
...
```java
Copy// Implementation of Section 2.6: Self-consistency
...
### [](#27-tree-of-thoughts-tot)2.7 Tree of Thoughts (ToT)
...
```java
Copy// Implementation of Section 2.7: Tree of Thoughts (ToT) - Game solving example
...
### [](#28-automatic-prompt-engineering)2.8 Automatic Prompt Engineering
...
```java
Copy// Implementation of Section 2.8: Automatic Prompt Engineering
...
### [](#29-code-prompting)2.9 Code Prompting
...
```java
Copy// Implementation of Section 2.9.1: Prompts for writing code

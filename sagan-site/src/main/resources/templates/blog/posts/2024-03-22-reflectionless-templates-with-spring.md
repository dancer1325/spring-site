...
source: https://spring.io/blog/2024/03/22/reflectionless-templates-with-spring
scraped: 2026-02-23T08:49:22.398Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Dave Syer |  March 22, 2024 | 5 Comments
---

# Reflectionless Templates With Spring

_Engineering | Dave Syer |  March 22, 2024 | 5 Comments_
...
### [](#jstachio-configuration)JStachio Configuration

There is also global configuration in the `DemoApplication` class:

```java
Copy@JStachePath(prefix = "templates/", suffix = ".mustache")
...
```java
Copy@JStacheConfig(using = DemoApplication.class)
package demo;
...
```
...
```
Copy$ tree target/generated-sources/annotations/
...
```
Copy$ while inotifywait src/main/resources/templates -e close_write; do \
  sleep 1; \
...
```
Copy$ docker run -p 8080:8080 demo:0.0.1-SNAPSHOT
...
```html
Copy@args (String title, RockerBody content)
...
### [](#rocker-configuration)Rocker Configuration
...
```java
Copypublic class RockerViewResolver implements ViewResolver, Ordered {
...
### [](#running-the-sample-1)Running the Sample
...
```
Copy$ tree target/generated-sources/rocker/
...
### [](#build-configuration-2)Build Configuration
...
### [](#jte-configuration)JTE Configuration
...
```
Copy$ tree target/generated-sources/jte/
...
### [](#build-configuration-3)Build Configuration
...
```java
Copypublic class StringView implements View {
...
### [](#running-the-sample-3)Running the Sample
...
```
Copy$ tree target/classes/templates/

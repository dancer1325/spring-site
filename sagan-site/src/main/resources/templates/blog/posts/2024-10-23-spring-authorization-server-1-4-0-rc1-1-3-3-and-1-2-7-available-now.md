...
source: https://spring.io/blog/2024/10/23/spring-authorization-server-1-4-0-rc1-1-3-3-and-1-2-7-available-now
scraped: 2026-02-23T08:11:02.146Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Joe Grandja |  October 23, 2024 | 0 Comments
---

# Spring Authorization Server 1.4.0-RC1, 1.3.3 and 1.2.7 available now

_Releases | Joe Grandja |  October 23, 2024 | 0 Comments_
...
See the [1.4.0-RC1](https://github.com/spring-projects/spring-authorization-server/releases/tag/1.4.0-RC1), [1.3.3](https://github.com/spring-projects/spring-authorization-server/releases/tag/1.3.3) and [1.2.7](https://github.com/spring-projects/spring-authorization-server/releases/tag/1.2.7) release notes for complete details.

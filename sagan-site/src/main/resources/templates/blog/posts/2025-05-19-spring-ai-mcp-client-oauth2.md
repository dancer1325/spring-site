...
source: https://spring.io/blog/2025/05/19/spring-ai-mcp-client-oauth2
scraped: 2026-02-23T07:42:15.837Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Daniel Garnier-Moiroux |  May 19, 2025 | 5 Comments
---

# MCP Authorization in practice with Spring AI and OAuth2

_Engineering | Daniel Garnier-Moiroux |  May 19, 2025 | 5 Comments_
...
```properties
Copy# Update the port so it does not clash with our Client application
server.port=8090
...
## [](#building-an-oauth2-authorization-server)Building an OAuth2 Authorization Server
...
```java
Copyvar chatResponse = chatClient.prompt("What is the weather in %s right now?".formatted(query))
        .call()
        .content();
```

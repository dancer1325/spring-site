...
source: https://spring.io/blog/2024/03/06/function-calling-in-java-and-spring-ai-using-the-latest-mistral-ai-api
scraped: 2026-02-23T08:53:09.884Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  March 06, 2024 | 0 Comments
---

# Function Calling in Java and Spring AI using the latest Mistral AI API

_Engineering | Christian Tzolov |  March 06, 2024 | 0 Comments_
...
# [](#1-function-calling-in-java)1\. Function Calling in Java
...
# [](#a-namefc-with-spring-ai2-function-calling-with-spring-aia)2\. Function Calling with Spring AI
...
## [](#21-how-does-it-work)2.1 How does it work?
...
```
Copyspring.ai.mistralai.api-key=${MISTRAL_AI_API_KEY}
...
```java
Copypublic record Transaction(String transactionId) {}
...
```java
Copyvar options = MistralAiChatOptions.builder()
...
```java
CopySystem.out.println(paymentStatusResponse.getResult().getOutput().getContent());
```

and expect a result like this:

```
CopyThe status of your transaction T1005 is "Pending".
```
...
## [](#22-dynamic-prompt-options)2.2 Dynamic Prompt Options
...
```java
CopyChatResponse paymentStatusResponse = chatClient
...
## [](#23-code-portability)2.3 Code Portability
...
2.  Adjust the `application.properties` file:
    ...
    ```
    Copyspring.ai.azure.openai.api-key=${AZURE_OPENAI_API_KEY}
...
# [](#3-build-native-graalvm-execution)3\. Build Native (GraalVM) Execution

---
title: Spring Authorization Server 1.0.0-M2 available now
source: https://spring.io/blog/2022/09/21/spring-authorization-server-1-0-0-m2-available-now
scraped: 2026-02-23T10:40:14.114Z
...
```
Copyimplementation 'org.springframework.security:spring-security-oauth2-authorization-server:1.0.0-M2'
```

See the [release notes](https://github.com/spring-projects/spring-authorization-server/releases/tag/1.0.0-M2) for complete details.

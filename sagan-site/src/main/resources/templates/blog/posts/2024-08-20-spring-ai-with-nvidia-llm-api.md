...
source: https://spring.io/blog/2024/08/20/spring-ai-with-nvidia-llm-api
scraped: 2026-02-23T08:19:49.940Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  August 20, 2024 | 0 Comments
---

# Spring AI with NVIDIA LLM API

_Engineering | Christian Tzolov |  August 20, 2024 | 0 Comments_
...
# [](#configuring-spring-ai)Configuring Spring AI
...
```
Copyexport SPRING_AI_OPENAI_API_KEY=<NVIDIA_API_KEY>
...
```
Copyspring.ai.openai.api-key=<NVIDIA_API_KEY>
...
# [](#toolfunction-calling)Tool/Function Calling

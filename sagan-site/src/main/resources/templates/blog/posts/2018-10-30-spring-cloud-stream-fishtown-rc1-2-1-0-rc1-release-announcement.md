---
title: Spring Cloud Stream Fishtown.RC1 /2.1.0.RC1 Release Announcement
source: https://spring.io/blog/2018/10/30/spring-cloud-stream-fishtown-rc1-2-1-0-rc1-release-announcement
scraped: 2026-02-23T15:08:22.111Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Oleg Zhurakousky |  October 30, 2018 | 0 Comments
---

# Spring Cloud Stream Fishtown.RC1 /2.1.0.RC1 Release Announcement

_Engineering | Oleg Zhurakousky |  October 30, 2018 | 0 Comments_
...
Spring Cloud Stream Fishtown 2.1.0.RC1 is available for use in the [Spring Milestone](http://repo.spring.io/libs-milestone-local/org/springframework/cloud/spring-cloud-stream/2.1.0.RC1/) repository.
...
Aside form changes and improvements in [M1](https://spring.io/blog/2018/06/28/spring-cloud-stream-fishtown-m1-2-1-0-m1-release-announcement) and [M2](https://spring.io/blog/2018/08/28/spring-cloud-stream-fishtown-m2-2-1-0-m2-release-announcement), here is the list of improvements for this [release](https://github.com/spring-cloud/spring-cloud-stream/milestone/48?closed=1)

#### [](#rabbit-binder)Rabbit Binder

Aside form changes and improvements in [M1](https://spring.io/blog/2018/06/28/spring-cloud-stream-fishtown-m1-2-1-0-m1-release-announcement) and [M2](https://spring.io/blog/2018/08/28/spring-cloud-stream-fishtown-m2-2-1-0-m2-release-announcement), here is the list of improvements for this [release](https://github.com/spring-cloud/spring-cloud-stream-binder-rabbit/milestone/29?closed=1)

#### [](#kafka-binder)Kafka Binder

Aside form changes and improvements in [M1](https://spring.io/blog/2018/06/28/spring-cloud-stream-fishtown-m1-2-1-0-m1-release-announcement) and [M2](https://spring.io/blog/2018/08/28/spring-cloud-stream-fishtown-m2-2-1-0-m2-release-announcement), here is the list of improvements for this [release](https://github.com/spring-cloud/spring-cloud-stream-binder-kafka/milestone/29?closed=1)
...
With this release we also want to highlight the recently released [Kinesis Binder](https://spring.io/blog/2018/08/21/spring-integration-for-aws-2-0-ga-and-spring-cloud-stream-kinesis-binder-1-0-ga)

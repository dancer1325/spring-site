---
title: Spring and Angular JS: A Secure Single Page Application
source: http://spring.io/blog/2015/01/12/spring-and-angular-js-a-secure-single-page-application
scraped: 2026-02-23T21:57:14.080Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Dave Syer |  January 12, 2015 | 50 Comments
---

# Spring and Angular JS: A Secure Single Page Application

_Engineering | Dave Syer |  January 12, 2015 | 50 Comments_
...
## [](#spring-and-the-single-page-application)Spring and the Single Page Application
...
```
Copy$ spring init --dependencies web,security ui/ && cd ui
```

Then jump to the [next section](#add-a-home-page).

### [](#using-the-initializr-website)Using the Initializr Website
...
### [](#features-of-the-home-page)Features of the Home Page
...
### [](#wro4j-source-files)Wro4j Source Files
...
-   `wro.properties` is a configuration file for the preprocessing and rendering engine in wro4j. You can use it to switch on and off various parts of the toolchain. In this case we use it to compile CSS from [Less](http://lesscss.org/) and to minify JavaScript, ultimately combining the sources from all the libraries we need in two files.
    ...
    ```
    Copy  preProcessors=lessCssImport
...
## [](#create-the-angular-application)Create the Angular Application
...
```
Copy$ curl localhost:8080/resource
...
### [](#whats-wrong-with-that)What's Wrong with That?

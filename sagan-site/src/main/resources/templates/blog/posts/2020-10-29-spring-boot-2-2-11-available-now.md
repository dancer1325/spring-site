---
title: Spring Boot 2.2.11 available now
source: https://spring.io/blog/2020/10/29/spring-boot-2-2-11-available-now
scraped: 2026-02-23T13:43:37.692Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Stéphane Nicoll |  October 29, 2020 | 0 Comments
---

# Spring Boot 2.2.11 available now

_Releases | Stéphane Nicoll |  October 29, 2020 | 0 Comments_
...
This release includes [50 bug fixes, documentation improvements, and dependency upgrades](https://github.com/spring-projects/spring-boot/releases/tag/v2.2.11.RELEASE). Thanks to all those who have contributed with issue reports and pull requests.
...
[Project Page](https://spring.io/projects/spring-boot/) | [GitHub](https://github.com/spring-projects/spring-boot) | [Issues](https://github.com/spring-projects/spring-boot/issues) | [Documentation](http://docs.spring.io/spring-boot/docs/2.2.11.RELEASE/reference/html) | [Stack Overflow](http://stackoverflow.com/questions/tagged/spring-boot) | [Gitter](https://gitter.im/spring-projects/spring-boot)
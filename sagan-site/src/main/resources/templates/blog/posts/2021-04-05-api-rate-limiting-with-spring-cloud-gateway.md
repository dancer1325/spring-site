...
source: https://spring.io/blog/2021/04/05/api-rate-limiting-with-spring-cloud-gateway
scraped: 2026-02-23T13:27:58.435Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Haytham Mohamed |  April 05, 2021 | 6 Comments
---

# API Rate Limiting with Spring Cloud Gateway

_Engineering | Haytham Mohamed |  April 05, 2021 | 6 Comments_
...
![link to rate limit image](https://static.spring.io/blog/haythamm/20210405/rate-limit-1.svg)
...
![link to rate limit image](https://static.spring.io/blog/haythamm/20210405/backend-gateway-frontend.svg)
...
```java
Copypublic interface KeyResolver {
...
```properties
Copyspring.cloud.gateway.filter.request-rate-limiter.deny-empty-key=false
```
...
```properties
Copyspring.cloud.gateway.filter.request-rate-limiter.empty-key-status-code=
```
...
![link to rate limit image](https://static.spring.io/blog/haythamm/20210405/redis-rate-limiting.svg)

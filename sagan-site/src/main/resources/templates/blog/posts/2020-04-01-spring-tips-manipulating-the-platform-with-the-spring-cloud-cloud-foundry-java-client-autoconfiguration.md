---
title: Spring Tips: Manipulating the Platform with the Spring Cloud Cloud Foundry Java Client Autoconfiguration
source: https://spring.io/blog/2020/04/01/spring-tips-manipulating-the-platform-with-the-spring-cloud-cloud-foundry-java-client-autoconfiguration
scraped: 2026-02-23T14:05:46.394Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Josh Long |  April 01, 2020 | 1 Comment
---

# Spring Tips: Manipulating the Platform with the Spring Cloud Cloud Foundry Java Client Autoconfiguration

_Engineering | Josh Long |  April 01, 2020 | 1 Comment_
...
## [](#what-is-cloud-foundry)What is Cloud Foundry?
...
## [](#our-sample-applications)Our Sample Applications
...
### [](#the-python-application)The Python Application
...
## [](#restaging-with-the-cloud-foundry-auto-configuration)Restaging with the Cloud Foundry Auto Configuration
...
```properties
Copyspring.cloud.cloudfoundry.space=joshlong
...
Pretty cool, eh? The programmable platform at work! Now, there's *zero* overhead associated with programming the platform.

NOTE: I borrowed, and greatly simplified, the code for the restager [from the Cloud Foundry Livelessons training video](https://www.oreilly.com/library/view/cloud-foundry-livelessons/9780134836126/) that [Josh McKenty](http://twitter.com/jmckenty) and I did in 2017.
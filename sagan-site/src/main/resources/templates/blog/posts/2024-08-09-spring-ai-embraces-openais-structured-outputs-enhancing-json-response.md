...
source: https://spring.io/blog/2024/08/09/spring-ai-embraces-openais-structured-outputs-enhancing-json-response
scraped: 2026-02-23T08:23:20.882Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  August 09, 2024 | ...
---

# Spring AI Embraces OpenAI's Structured Outputs: Enhancing JSON Response Reliability

_Engineering | Christian Tzolov |  August 09, 2024 | ..._
...
### [](#using-the-beanoutputconverter)Using the BeanOutputConverter
...
## [](#configuring-via-application-properties)Configuring via Application Properties
...
```
Copyspring.ai.openai.api-key=YOUR_API_KEY

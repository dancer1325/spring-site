...
source: https://spring.io/blog/2025/11/10/spring-ai-llm-as-judge-blog-post
scraped: 2026-02-23T07:22:32.942Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  November 10, 2025 | 0 Comments
---

# LLM Response Evaluation with Spring AI: Building LLM-as-a-Judge Using Recursive Advisors

_Engineering | Christian Tzolov |  November 10, 2025 | 0 Comments_
...
## [](#understanding-llm-as-a-judge)Understanding LLM-as-a-Judge
...
## [](#choosing-the-right-judge-model)Choosing the Right Judge Model
...
## [](#spring-ai-the-perfect-foundation)Spring AI: The Perfect Foundation
...
### [](#the-selfrefineevaluationadvisor-implementation)The SelfRefineEvaluationAdvisor Implementation
...
```java
Copypublic final class SelfRefineEvaluationAdvisor implements CallAdvisor {
...
```
CopyREQUEST: [{"role":"user","content":"What is current weather in Paris?"}]

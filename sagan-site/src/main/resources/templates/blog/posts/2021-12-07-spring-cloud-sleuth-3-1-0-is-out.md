---
title: Spring Cloud Sleuth 3.1.0 is out!
source: https://spring.io/blog/2021/12/07/spring-cloud-sleuth-3-1-0-is-out
scraped: 2026-02-23T13:01:39.603Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Marcin Grzejszczak |  December 07, 2021 | 0 Comments
---

# Spring Cloud Sleuth 3.1.0 is out!

_Engineering | Marcin Grzejszczak |  December 07, 2021 | 0 Comments_
...
## [](#automatic-tag-table-generation-for-documentation)Automatic tag table generation for documentation
...
## [](#spring-cloud-deployer)Spring Cloud Deployer
...
## [](#kafka-and-reactor-kafka)Kafka and Reactor Kafka
...
## [](#spring-cloud-circuitbreaker-reactive)Spring Cloud CircuitBreaker Reactive
...
![Exemplars example](https://github.com/marcingrzejszczak/sleuth-3_1_0-blog/blob/main/images/exemplars1.png?raw=true)

![Exemplars example](https://github.com/marcingrzejszczak/sleuth-3_1_0-blog/blob/main/images/exemplars2.png?raw=true)

## [](#spring-cloud-stream-reactive)Spring Cloud Stream Reactive
...
## [](#abstracted-redis-instrumentation)Abstracted Redis instrumentation
...
## [](#custom-actuator-for-storing-traces)Custom Actuator for storing traces

---
title: RabbitMQ Java Client 4.0 is released | RabbitMQ
source: http://www.rabbitmq.com/blog/2016/11/24/rabbitmq-java-client-4-0-is-released/
scraped: 2026-02-23T18:56:44.890Z
description: The RabbitMQ team is happy to announce the release of version 4.0 of the RabbitMQ Java Client. This new release does not introduce any breaking changes and comes with a bunch of interesting new features.
---

# RabbitMQ Java Client 4.0 is released | RabbitMQ
...
## New independent release process[​](#new-independent-release-process "Direct link to New independent release process")
...
## Logging support with SLF4J[​](#logging-support-with-slf4j "Direct link to Logging support with SLF4J")
...
## Metrics support[​](#metrics-support "Direct link to Metrics support")
...
## Support for Java NIO[​](#support-for-java-nio "Direct link to Support for Java NIO")
...
## Automatic recovery enabled by default[​](#automatic-recovery-enabled-by-default "Direct link to Automatic recovery enabled by default")
...
## Miscellaneous goodies and fixes[​](#miscellaneous-goodies-and-fixes "Direct link to Miscellaneous goodies and fixes")

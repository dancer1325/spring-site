...
source: https://spring.io/blog/2025/04/02/mcp-server-oauth2
scraped: 2026-02-23T07:42:20.893Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Daniel Garnier-Moiroux |  April 02, 2025 | 6 Comments
---

# Securing Spring AI MCP servers with OAuth2

_Engineering | Daniel Garnier-Moiroux |  April 02, 2025 | 6 Comments_
...
## [](#authorization-and-security-in-mcp)Authorization and security in MCP
...
```shell
Copycurl https://mcp.example.com/sse
...
## [](#adding-oauth2-to-your-spring-mcp-server)Adding OAuth2 to your Spring MCP server
...
```properties
Copyspring.security.oauth2.authorizationserver.client.oidc-client.registration.client-id=mcp-client
...
```java
Copyimport static org.springframework.security.oauth2.server.authorization.config.annotation.web.configurers.OAuth2AuthorizationServerConfigurer.authorizationServer;
...
```shell
Copycurl http://localhost:8080/sse --fail-with-body
#
# Response:
#
...
```shell
Copycurl -XPOST http://localhost:8080/oauth2/token --data grant_type=client_credentials --user mcp-client:secret
#
# Response:
#
...
```shell
Copycurl http://localhost:8080/sse -H"Authorization: Bearer YOUR_ACCESS_TOKEN"
#
# Response:
#

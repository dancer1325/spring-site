---
title: Spring Boot 2.3.8 available now
source: https://spring.io/blog/2021/01/14/spring-boot-2-3-8-available-now
scraped: 2026-02-23T13:34:48.227Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Scott Frederick |  January 14, 2021 | 0 Comments
---

# Spring Boot 2.3.8 available now

_Releases | Scott Frederick |  January 14, 2021 | 0 Comments_
...
This release includes [35 bug fixes and dependency upgrades](https://github.com/spring-projects/spring-boot/releases/tag/v2.3.8.RELEASE). Thanks to all those who have contributed with issue reports and pull requests.
...
[Project Page](https://spring.io/projects/spring-boot/) | [GitHub](https://github.com/spring-projects/spring-boot) | [Issues](https://github.com/spring-projects/spring-boot/issues) | [Documentation](http://docs.spring.io/spring-boot/docs/2.3.8.RELEASE/reference/html) | [Stack Overflow](http://stackoverflow.com/questions/tagged/spring-boot) | [Gitter](https://gitter.im/spring-projects/spring-boot)
---
title: Spring Boot 2.4.5 available now
source: https://spring.io/blog/2021/04/15/spring-boot-2-4-5-available-now
scraped: 2026-02-23T13:26:51.885Z
description: Level up your Java code and explore what Spring can do for you.
meta: Releases | Stéphane Nicoll |  April 15, 2021 | 2 Comments
---

# Spring Boot 2.4.5 available now

_Releases | Stéphane Nicoll |  April 15, 2021 | 2 Comments_
...
This release includes [57 bug fixes, documentation improvements, and dependency upgrades](https://github.com/spring-projects/spring-boot/releases/tag/v2.4.5). Thanks to all those who have contributed with issue reports and pull requests.
...
[Project Page](https://spring.io/projects/spring-boot/) | [GitHub](https://github.com/spring-projects/spring-boot) | [Issues](https://github.com/spring-projects/spring-boot/issues) | [Documentation](http://docs.spring.io/spring-boot/docs/2.4.5/reference/html) | [Stack Overflow](http://stackoverflow.com/questions/tagged/spring-boot) | [Gitter](https://gitter.im/spring-projects/spring-boot)
---
title: Getting Started with Couchbase and Spring Data Couchbase
source: https://spring.io/blog/2015/03/16/getting-started-with-couchbase-and-spring-data-couchbase
scraped: 2026-02-23T21:51:33.937Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Josh Long |  March 16, 2015 | 6 Comments
---

# Getting Started with Couchbase and Spring Data Couchbase

_Engineering | Josh Long |  March 16, 2015 | 6 Comments_
...
### [](#use-vagrant-to-run-couchbase-locally)Use Vagrant to Run Couchbase Locally
...
```sh
CopyVAGRANT_NODES=2 vagrant up
```
...
![](https://raw.githubusercontent.com/joshlong/meh/master/sd-couchbase-blog/server-nodes.png)
...
```sh
Copy/opt/couchbase/bin/couchbase-cli server-list -c 192.168.56.101 -u admin -p password
```

It's easy to trigger a *rebalance* using:

```sh
Copy/opt/couchbase/bin/couchbase-cli rebalance -c 192.168.56.101 -u admin -p password
```

### [](#couchbase-in-the-cloud-and-on-cloud-foundry)Couchbase In the Cloud and on Cloud Foundry
...
## [](#using-spring-data-couchbase-to-store-facebook-places)Using Spring Data Couchbase to Store Facebook Places
...
### [](#get-a-facebook-access-token)Get a Facebook Access Token
...
![](https://raw.githubusercontent.com/joshlong/meh/master/sd-couchbase-blog/facebook-app.png)

### [](#telling-spring-data-couchbase-about-our-cluster)Telling Spring Data Couchbase About our Cluster
...
### [](#a-spring-data-couchbase-repository)A Spring Data Couchbase Repository
...
![](https://raw.githubusercontent.com/joshlong/meh/master/sd-couchbase-blog/all-view.png)

Now, `byName`:

![](https://raw.githubusercontent.com/joshlong/meh/master/sd-couchbase-blog/byName-view.png)

When you're done, be sure to *Publish* each view!

![](https://raw.githubusercontent.com/joshlong/meh/master/sd-couchbase-blog/views.png)
...
The code for [this example is in my Github repository](https://github.com/joshlong/spring-data-couchbase-talk), co-developed with my pal Laurent Doguin ([@ldoguin](https://twitter.com/ldoguin)) over at Couchbase.
...
source: https://spring.io/blog/2024/07/31/spring-ai-with-groq-a-blazingly-fast-ai-inference-engine
scraped: 2026-02-23T08:24:12.443Z
description: Level up your Java code and explore what Spring can do for you.
meta: Engineering | Christian Tzolov |  July 31, 2024 | 1 Comment
---

# Spring AI with Groq - a blazingly fast AI inference engine

_Engineering | Christian Tzolov |  July 31, 2024 | 1 Comment_
...
# [](#configuring-spring-ai-for-groq)Configuring Spring AI for Groq
...
```
Copyexport SPRING_AI_OPENAI_API_KEY=<INSERT GROQ API KEY HERE>  
...
```
Copyspring.ai.openai.api-key=<GROQ_API_KEY>
...
# [](#toolsfunctions)Tools/Functions
